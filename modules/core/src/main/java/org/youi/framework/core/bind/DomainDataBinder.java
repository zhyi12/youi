 ...
 */
package org.youi.framework.core.bind;
 ...
 */
public class DomainDataBinder extends DataBinder {
	...
	/**
	 * Create a new DomainDataBinder instance, with default object name.
	 * @param target the target object to bind onto (or <code>null</code>
	 * if the binder is just used to convert a plain parameter value)
	 * @see #DEFAULT_OBJECT_NAME
	 */
	public DomainDataBinder(Object target) {
		super(target);
	}

	/**
	 * Create a new DomainDataBinder instance.
	 * @param target the target object to bind onto (or <code>null</code>
	 * if the binder is just used to convert a plain parameter value)
	 * @param objectName the name of the target object
	 */
	public DomainDataBinder(Object target, String objectName) {
