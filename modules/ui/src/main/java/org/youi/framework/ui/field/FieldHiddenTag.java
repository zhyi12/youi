...
import org.youi.framework.ui.field.model.FieldHidden;

public class FieldHiddenTag extends AbstractFieldTag {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8532433358774950174L;


	protected AbstractField createField() {
		FieldHidden field = new FieldHidden();
		field.setId(id);
	...
	public String uiContentHtml() {
		return "<input class=\"value\" name=\""+this.getFieldFormName()+"\" type=\"hidden\"></input>";
	}
}
