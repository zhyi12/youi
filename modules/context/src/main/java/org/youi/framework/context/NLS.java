 ...
 * @since 3.1
 */
public abstract class NLS implements ResourceLoaderAware{
	
	private final static Log logger = LogFactory.getLog(NLS.class);
...
//		resourceLoader.getResource(location)
	...
	private static class MessagesProperties extends Properties {
		...
		public MessagesProperties(@SuppressWarnings("rawtypes") Map fieldMap, String bundleName, boolean isAccessible) {
			super();
